...
def add_basestation(map_name):
    ...
    lte_b5_pci_list = [
        ...
        (15, 37.54541233, 126.98541890),
        (19, 37.54303361, 126.98501861),
        (20, 37.55464817, 126.97608312),
        (29, 37.55367306, 126.97850833),
        (37, 37.54443639, 126.98671278),
        (73, 37.55128250, 126.97917694),
        (84, 37.55244740, 126.98724844),
        (136, 37.54406611, 126.98321917),
        (155, 37.54721361, 126.98147333),
        (181, 37.54667750, 126.98423639),
        (184, 37.55180287, 126.98864142),
        (201, 37.55197400, 126.98008300),
        (204, 37.54511622, 126.98382172),
        (207, 37.54313435, 126.98617105),
        (231, 37.55555056, 126.98149556),
        (233, 37.55286576, 126.98172569),
        (241, 37.54963306, 126.98153194),
        (258, 37.55475194, 126.97682667),
        (265, 37.54479389, 126.98173750),
        (281, 37.55439900, 126.98188100),
        (296, 37.54359700, 126.98431500),
        (303, 37.54596253, 126.98509033),
        (306, 37.55678944, 126.97997528),
        (307, 37.55008833, 126.98204222),
        (308, 37.55189420, 126.97919868),
        (310, 37.55456534, 126.98103536),
        (354, 37.55244740, 126.98724844),
        (366, 37.54566688, 126.98288902),
        (368, 37.55244740, 126.98724844),
        (390, 37.55118544, 126.98810640),
        (391, 37.55118544, 126.98810640),
        (414, 37.55439900, 126.98188100),
        (420, 37.55244740, 126.98724844),
        (443, 37.54448300, 126.98577600),
        (444, 37.54448300, 126.98577600),
        (446, 37.54448300, 126.98577600),
...
def popup_table(idx, val, df, metric, band):
    ...
    if isinstance(test_list, list) and len(test_list) > 0:
        ...
        """
        base_url = f"https://joostone-ahn.github.io/nr-field-analysis/results/plot/plot_each_test"
